...
<<<<<<< HEAD
=======
  modified: 2026-08-17T09:36:31.959Z
>>>>>>> d55e9bd (Auto-sync: Claude Code session (sham))
---
...
2026-08-17 기준 **렉노 19개 전부 + 스킬 템플릿에 이식 완료**(CSS/JS 블록 해시 동일 확인, jsdom 검증 통과).
일괄 이식 스크립트: `.claude/skills/lecture-note/references/patch_wings.py`.
