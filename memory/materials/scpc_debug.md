...
### OSZICAR 중간 step 유실
SCPC 계산에서 OSZICAR 중간 데이터가 유실된 사례:
- 초기 SCF(SCPC 적용 전): DAV 1~35만 남음
- 최종 SCF(SCPC 마지막 cycle 후): DAV 43~48만 남음
- 중간 SCPC cycle들의 DAV step은 유실됨
...
**How to apply:** SCPC 출력 분석 시 SCPCOUT의 interleaving에 주의. COR/PER 두 시리즈를 cycle 번호로 구분해서 읽어야 함. OSZICAR 중간 step 유실 가능성도 염두.
