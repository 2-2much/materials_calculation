...
metadata: 
  ...
  modified: 2026-07-22T11:21:18.402Z
---
...
## 04-InCl3-passv 추가 측정 (2026-07-22)

`Cl_i-As/q0/02_G221-DOS`(2×2×1, ISPIN=1, ISMEAR=−5, NELECT=1023) 완주분에서 동일 방법:

| defect | 밴드 | 전자수 | E_min | ⟨E⟩ | 채움 |
|---|---|---|---|---|---|
| **Cl_i-As (04)** | 512 | **1.0000** | 0.0007 | 0.2868 | **0.286 eV** |

k별 상세 = Γ 0.0007(occ 1.2825) / X 0.7496(0.3444) / Y 0.7889(0.2979) / S 1.0581(0.0752).
전자 1개짜리 도너 3건이 **0.186 / 0.286 / 0.330 eV** 로 모여 있어 규모가 재확인된다 —
**주입값 0.78 eV는 2.4~4.2배 과대로 확정. 쓰지 말 것.**

부수 소득: 이 밴드의 **분산 폭이 1.058 eV**(Γ→S)로 나와 IPR 게이트에서 `n/a`였던
**dispersion 축이 처음 채워졌다**(shallow 문턱 0.30 eV의 3.5배 → 확실한 shallow).
→ [[charge_state_selection_rule]]
