...
metadata: 
  ...
  modified: 2026-07-22T05:53:23.438Z
---
...
## 조치 (2026-07-22)
`~/bin/slabcc` 소스에 **`SLABCC_CHARGE_TOLERANCE` 환경변수 override** 추가 후 재빌드(`bin/build_local.sh`). 미설정 시 1e-4 그대로 → **기존 동작 불변**. 번들 회귀테스트 통과: E_corr 0.500213792 vs 참조 0.500213687 (1e-7 eV 일치). 구 바이너리 백업 `bin/slabcc.orig_1e-4.bak`.
