...
metadata: 
  ...
  modified: 2026-08-04T04:29:05.026Z
---
...
- **깊은/bound 하전 상태** → **HSE 직접 이완**(확정). PBE 1shot 으로 대체하면 **~100 meV** 잔차가 남고
  CTL 을 그대로 밀어낸다(합격선 50 meV 초과 → **불합격**). 회수율이 70% 로 높아도 **잔차의 절대크기**가
  기준이다 — 회수율이 좋다고 채택하면 안 된다.
